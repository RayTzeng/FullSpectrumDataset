...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Sample weighted Stage-2 question/answer templates and instantiate them "
            "against metadata. Outputs JSONL or JSONL.GZ rows with keys: "
