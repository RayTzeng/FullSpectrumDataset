...
def choose_template_indices(
    ...
    # First include every template at most once, then sample extra draws with replacement.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Instantiate weighted QA templates against metadata and write JSONL or JSONL.GZ "
            "rows with keys: question, answer, metadata."
        )
    )
