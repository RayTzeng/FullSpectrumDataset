...
## Supported Tasks
1. **Single-Label Audio Event Classification**
...
### 1. Single-Label Audio Event Classification
- **Target field:** `event_label` (sound event label)
...
- VGGSound is used here as an **audio-only** benchmark for single-label sound event classification.
