...
## Overview
**VGGSound** is a large-scale audio-visual dataset containing video clips labeled with diverse real-world sound events, covering categories such as human activities, animal sounds, musical instruments, and environmental noises.
...
| `event_label` | Ground-truth sound event label |
...
```json
{"id": "e6CwmHGucg8_000004", "path": "/saltpool0/scratch/tseng/FullSpectrumDataset/raw/VggSound/train/e6CwmHGucg8_000004.wav", "duration": 10.002, "dataset": "VggSound", "sampling_rate": 16000, "event_label": "playing timbales"}

{"id": "ttNFXW3ZEvw_000010", "path": "/saltpool0/scratch/tseng/FullSpectrumDataset/raw/VggSound/train/ttNFXW3ZEvw_000010.wav", "duration": 10.008, "dataset": "VggSound", "sampling_rate": 16000, "event_label": "people belly laughing"}

{"id": "RAdHUi4vqb8_000010", "path": "/saltpool0/scratch/tseng/FullSpectrumDataset/raw/VggSound/train/RAdHUi4vqb8_000010.wav", "duration": 10.008, "dataset": "VggSound", "sampling_rate": 16000, "event_label": "people screaming"}
```
...
- VGGSound is used here as an **audio-only** benchmark for audio event classification.
- There is no `dev` split in the provided manifest.
- This is a **single-label** classification task - each sample has one event label.