# LibriSpeech Punctuated ASR (LibriSpeech-PC)

## Overview
**Punctuated Automatic Speech Recognition (Punctuated ASR)** requires models to transcribe speech **while restoring proper punctuation**.

This task uses **LibriSpeech-PC**, a punctuated version of LibriSpeech where punctuation is restored in the transcripts. Models must produce grammatically correct text including punctuation marks such as commas and periods.

The data folder contains the following splits:
