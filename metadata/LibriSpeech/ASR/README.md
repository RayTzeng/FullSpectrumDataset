...
## Overview
Automatic Speech Recognition (ASR) converts spoken audio into its corresponding text transcription.

This task uses the **LibriSpeech** dataset, a large-scale corpus of read English speech derived from LibriVox audiobooks. Audio is recorded at **16 kHz** and paired with verbatim transcripts.
